...
def get_memory_service():
    ...
    project = os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-03-ffdf266e9f9f")
    location = (
    ...
    if location == "global":
        location = "us-east1"
    agent_engine_id = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID", "6920853950803476480")
